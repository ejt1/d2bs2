...
// clang-format off
PatchHook Patches[] = {
    {PatchJmp,    GetDllOffset("D2Client.dll",  0x53B30),   (DWORD)GameDraw,                5}, // Updated 1.14d //00453B30-BASE
    {PatchCall,   GetDllOffset("D2Win.dll",     0xF9A0D),   (DWORD)GameDrawOOG,             5}, // Updated 1.14d //004F9A0D-BASE
