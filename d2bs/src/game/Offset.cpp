...
DWORD GetDllOffset(const char*, int Offset) {
...
DWORD GetDllOffset(int num) {
  static const char* dlls[] = {"D2Client.DLL", "D2Common.DLL", "D2Gfx.DLL",    "D2Lang.DLL", "D2Win.DLL",
...
void InstallConditional() {
  ...
  //  ::ReadProcessMemory(GetCurrentProcess(), (void*)Conditional[x].dwAddr, Conditional[x].bOldCode,
  //                      Conditional[x].dwLen, NULL);
