...
#define ASMPTR(d1, v1, o1) extern DWORD d1##_##v1;
    ...
    FUNCPTR(D2CLIENT, FindClientSideUnit, UnitAny* __fastcall, (DWORD dwId, DWORD dwType),
            0x63990)  // Updated 1.14d //00463990-BASE
    FUNCPTR(D2CLIENT, FindServerSideUnit, UnitAny* __fastcall, (DWORD dwId, DWORD dwType),
            0x639B0)                                                                   // Updated 1.14d //004639B0-BASE
    ...
    FUNCPTR(D2CLIENT, GetItemName, BOOL __fastcall, (UnitAny * pItem, wchar_t* wBuffer, DWORD dwSize),
            0x8C060)  // Updated 1.14d //0048C060-BASE
    FUNCPTR(D2CLIENT, LoadItemDesc, BOOL __stdcall, (UnitAny * pItem, int type),
            0x8DD90)                                                                   // Updated 1.14d //0048DD90-BASE
    ...
    FUNCPTR(D2CLIENT, SetUIVar, DWORD __fastcall, (DWORD varno, DWORD howset, DWORD unknown1),
    ...
    FUNCPTR(D2CLIENT, AddAutomapCell, void __fastcall, (AutomapCell * aCell, AutomapCell** node),
    ...
    FUNCPTR(D2CLIENT, InitAutomapLayer_I, AutomapLayer* __fastcall, (DWORD nLayerNo),
            0x58D40)  // Updated 1.14d //00458D40-BASE

    FUNCPTR(D2CLIENT, ClickMap, void __fastcall, (DWORD MouseFlag, DWORD x, DWORD y, DWORD Type),
            0x62D00)  // Updated 1.14d //00462D00-BASE
    FUNCPTR(D2CLIENT, LeftClickItem_I, void __stdcall,
            (UnitAny * pPlayer, Inventory* pInventory, int x, int y, DWORD dwClickType, InventoryLayout* pLayout,
             DWORD Location),
    ...
    FUNCPTR(D2CLIENT, PrintGameString, void __fastcall, (wchar_t * wMessage, int nColor),
            0x9E3A0)  // Updated 1.14d //0049E3A0-BASE
    FUNCPTR(D2CLIENT, PrintPartyString, void __fastcall, (wchar_t * wMessage, int nColor),
            0x9E5C0)  // Updated 1.14d //0049E5C0-BASE
    ...
    FUNCPTR(D2CLIENT, TestPvpFlag, DWORD __fastcall, (DWORD dwUnitId1, DWORD dwUnitId2, DWORD dwFlag),
    ...
    FUNCPTR(D2COMMON, LoadAct, Act* __stdcall,
            (DWORD ActNumber, DWORD MapId, DWORD Unk, DWORD Unk_2, DWORD Unk_3, DWORD Unk_4, DWORD TownLevelId,
             DWORD Func_1, DWORD Func_2),
    ...
    FUNCPTR(D2COMMON, GetLayer, AutomapLayer2* __fastcall, (DWORD dwLevelNo),
            0x21E470)  // Updated 1.14d //0061E470-BASE
    FUNCPTR(D2COMMON, GetLevel, Level* __fastcall, (ActMisc * pMisc, DWORD dwLevelNo),
            0x242AE0)  // Updated 1.14d //00642AE0-BASE

    FUNCPTR(D2COMMON, GetStatList, StatList* __stdcall, (UnitAny * pUnit, DWORD dwUnk, DWORD dwMaxEntries),
            0x2257D0)  // Updated 1.14d //006257D0-BASE
    FUNCPTR(D2COMMON, CopyStatList, DWORD __stdcall, (StatList * pStatList, Stat* pStatArray, DWORD dwMaxEntries),
            0x225C90)  // Updated 1.14d //0625C90-BASE
    FUNCPTR(D2COMMON, GetUnitStat, DWORD __stdcall, (UnitAny * pUnit, DWORD dwStat, DWORD dwStat2),
            0x225480)  // Updated 1.14d //00625480-BASE
    FUNCPTR(D2COMMON, GetUnitState, int __stdcall, (UnitAny * pUnit, DWORD dwStateNo),
            0x239DF0)  // Updated 1.14d //00639DF0-BASE

    FUNCPTR(D2COMMON, CheckUnitCollision, DWORD __stdcall, (UnitAny * pUnitA, UnitAny* pUnitB, DWORD dwBitMask),
    ...
    FUNCPTR(D2COMMON, GetTargetUnitType, Path* __stdcall, (Path * pPath), 0x773C0)
        ...
        FUNCPTR(D2COMMON, GetSkillLevel, INT __stdcall, (UnitAny * pUnit, Skill* pSkill, BOOL bTotal),
                0x2442A0)  // Updated 1.14d //006442A0-BASE

    FUNCPTR(D2COMMON, GetItemLevelRequirement, DWORD __stdcall, (UnitAny * pItem, UnitAny* pPlayer),
            0x22BA60)  // Updated 1.14d //0062BA60-BASE

    FUNCPTR(D2COMMON, GetItemPrice, DWORD __stdcall,
            (UnitAny * MyUnit, UnitAny* pItem, DWORD U1_, DWORD U2_, DWORD U3_, DWORD U4_),
            0x22FDC0)  // Updated 1.14d //0062FDC0-BASE
    FUNCPTR(D2COMMON, GetRepairCost, DWORD __stdcall,
    ...
    FUNCPTR(D2COMMON, GetItemMagicalMods, char* __stdcall, (WORD wPrefixNum),
            0x233EE0)  // Updated 1.14d //00633EE0-BASE
    FUNCPTR(D2COMMON, GetItemFromInventory, UnitAny* __stdcall, (Inventory * inv),
            0x23B2C0)  // Updated 1.14d //0063B2C0-BASE
    FUNCPTR(D2COMMON, GetNextItemFromInventory, UnitAny* __stdcall, (UnitAny * pItem),
            0x23DFA0)  // Updated 1.14d //0063DFA0-BASE

    FUNCPTR(D2COMMON, GenerateOverheadMsg, OverheadMsg* __stdcall, (DWORD dwUnk, CHAR* szMsg, DWORD dwTrigger),
            0x261110)  // Updated 1.14d //00661110-BASE
    FUNCPTR(D2COMMON, FixOverheadMsg, VOID __stdcall, (OverheadMsg * pMsg, DWORD dwUnk),
            0x261230)  // Updated 1.14d //00661230-BASE

    FUNCPTR(D2COMMON, AddRoomData, void __stdcall, (Act * ptAct, int LevelId, int Xpos, int Ypos, Room1* pRoom),
            0x21A070)  // Updated 1.14d //0061A070-BASE
    FUNCPTR(D2COMMON, RemoveRoomData, void __stdcall, (Act * ptAct, int LevelId, int Xpos, int Ypos, Room1* pRoom),
            0x21A0C0)  // Updated 1.14d //0061A0C0-BASE

    FUNCPTR(D2COMMON, GetQuestFlag, int __stdcall, (void* QuestInfo, DWORD dwAct, DWORD dwQuest),
    ...
    FUNCPTR(D2COMMON, AbsScreenToMap, void __stdcall, (long* ptMouseX, long* ptMouseY),
            0x243510)  // Updated 1.14d  //00643510-BASE

    FUNCPTR(D2COMMON, CheckWaypoint, DWORD __stdcall, (DWORD WaypointTable, DWORD dwLevelId),
    ...
    FUNCPTR(D2COMMON, FindRoom1, Room1* __stdcall, (Act * pAct, int x, int y),
            0x219DA3)  // Updated 1.14d //00619DA3-BASE
    ...
    FUNCPTR(D2NET, SendPacket, void __stdcall, (size_t aLen, DWORD arg1, BYTE* aPacket),
            0x12AE50)  // Updated 1.14d //0052AE50-BASE
    FUNCPTR(D2NET, ReceivePacket, void __fastcall, (BYTE * aPacket, DWORD aLen),
            0x12AEB0)  // Updated 1.14d //0052AEB0-BASE
    FUNCPTR(D2NET, ReceivePacket_I, void __fastcall, (BYTE * aPacket, DWORD aLen, int* arg3),
    ...
    // //004F6510-BASE
    FUNCPTR(D2GFX, DrawRectangle, void __stdcall, (int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwTrans),
            0xF6300)  // Updated 1.14d //004F6300-BASE
    FUNCPTR(D2GFX, DrawLine, void __stdcall, (int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwUnk),
            0xF6380)  // Updated 1.14d //004F6380-BASE
    FUNCPTR(D2GFX, DrawAutomapCell2, void __stdcall,
    ...
    FUNCPTR(D2MULTI, PrintChannelText_, void __fastcall, (int unused, char* szText, DWORD dwColor),
    ...
    FUNCPTR(D2CMP, InitCellFile, VOID __stdcall,
    ...
    FUNCPTR(D2WIN, SetControlText, void* __fastcall, (Control * box, const wchar_t* txt),
            0xFF5A0)                                               // Updated 1.14d //004FF5A0-BASE
    FUNCPTR(D2WIN, DrawSprites, void __fastcall, (void), 0xF9870)  // Updated 1.14d //004F9870-BASE
    FUNCPTR(D2WIN, LoadCellFile, CellFile* __fastcall, (const char* szFile, int Type),
            0xFA9B0)  // Updated 1.14d //004FA9B0-BASE
    ...
    FUNCPTR(D2WIN, DrawText, void __fastcall, (const wchar_t* wStr, int xPos, int yPos, DWORD dwColor, DWORD dwUnk),
            0x102320)  // Updated 1.14d //00502320-BASE
    FUNCPTR(D2WIN, GetTextSize, DWORD __fastcall, (wchar_t * wStr, DWORD* dwWidth, DWORD* dwFileNo),
    ...
    FUNCPTR(D2WIN, GetTextWidthFileNo, DWORD __fastcall, (wchar_t * wStr, DWORD* dwWidth, DWORD* dwFileNo),
            0x102520)                                                              // Updated 1.14d //00502520-BASE
    ...
    FUNCPTR(D2WIN, SetEditBoxCallback, VOID __fastcall,
    ...
    FUNCPTR(D2WIN, SetEditBoxProc, void __fastcall,
    ...
    FUNCPTR(D2WIN, InitMPQ, DWORD __fastcall, (const char* mpqfile, char* mpqname, int v4, int v5),
...
// #define D2CLIENT_LoadUIImage(x)
// ((CellFile*)D2CLIENT_LoadUIImage_ASM(x))
